...
import com.active.mq.config.MQConfiguration;
import com.active.mq.config.SpringConfiguration;
...
public class AppInitializer implements WebApplicationInitializer {
    ...
    private void registerContextLoaderListener(ServletContext servletContext) {
        ...
        webContext = createWebApplicationContext(SpringConfiguration.class, MQConfiguration.class);
